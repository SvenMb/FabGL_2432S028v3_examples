...
#include "fabglconf.h"
#include "fabutils.h"
#include "dispdrivers/TFTControllerGeneric.h"
...
/**
 * @brief Implements ST7789 display driver controller without inverting output.
 *
 * Example:
 *
 ...
 *     }
 */
class ST7789nController : public TFTController {
protected:
  void softReset();
};
