...
// ------------------ added by Guido Lehwalder start
// REBOOT command
uint8 _ccp_reboot(void) {
        _clrscr();
        _puts("\e[1m");
        _puts("\e[5m");        
        _puts("8888888b.  8888888888 888888b.    .d88888b.   .d88888b. 88888888888 \r\n");
        _puts("888   Y88b 888        888  '88b  d88P' 'Y88b d88P' 'Y88b    888     \r\n");
        _puts("888    888 888        888  .88P  888     888 888     888    888     \r\n");
        _puts("888   d88P 8888888    8888888K.  888     888 888     888    888     \r\n");
        _puts("8888888P'  888        888  'Y88b 888     888 888     888    888     \r\n");
        _puts("888 T88b   888        888    888 888     888 888     888    888     \r\n");
        _puts("888  T88b  888        888   d88P Y88b. .d88P Y88b. .d88P    888     \r\n");
        _puts("888   T88b 8888888888 8888888P'   'Y88888P'   'Y88888P'     888     \r\n");
        _puts("\e[0m");
        _puts("______________________________");
        _puts("\r\nReboot requested via \e[91mBREAK-Key\e[0m");
        _puts("\r\nReboot requested...");
        ...
        _puts("\r\n");
        _puts("\e[0m");        
        _puts("[\e[91m\e#6\e#3REBOOT\e[0m]\r\n"); // top    half of REBOOT Double Height Line
        _puts("[\e[91m\e#6\e#4REBOOT\e[0m]\r\n"); // bottom half of REBOOT Double Height Line
        
        Terminal.soundGenerator()->playSound(SquareWaveformGenerator(), 1000, 20);
        delay(1000);
        ESP.restart();
                  }
// ------------------ added by Guido Lehwalder end                           
